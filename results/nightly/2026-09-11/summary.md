# Nightly Test Results — 2026-09-11

| Test | Result |
|------|--------|
| Conformance | 615 passed, 0 failed, 22 skipped |
| Performance | 779013 fixed-rate requests, success rate 1, saturation 50.015 RPS |

## Performance Scenarios

| Scenario | Rate | p50 | p95 | p99 | Requests | Success |
|----------|------|-----|-----|-----|----------|---------|
| simple | 3000/s | 11ms | 19ms | 24ms | 149014 | 1 |
| path-users | 2000/s | 4ms | 11ms | 18ms | 120000 | 1 |
...
| response-header-filter | 1000/s | 1ms | 2ms | 3ms | 59999 | 1 |
...
Images tested:
- Control Plane: ghcr.io/nantian-gw/nantian-controlplane:ci-20d09aff6b0399f67dbc5ac4444ee0818bae1089
