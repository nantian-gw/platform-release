# Nightly Test Results — 2026-09-19

| Test | Result |
|------|--------|
| Conformance | 615 passed, 0 failed, 22 skipped |
| Performance | 803768 fixed-rate requests, success rate 1, saturation 50.014 RPS |

## Performance Scenarios

| Scenario | Rate | p50 | p95 | p99 | Requests | Success |
|----------|------|-----|-----|-----|----------|---------|
| simple | 3000/s | 9ms | 17ms | 21ms | 173777 | 1 |
| path-users | 2000/s | 3ms | 7ms | 12ms | 120000 | 1 |
| path-orders | 2000/s | 3ms | 7ms | 11ms | 119991 | 1 |
| header-data | 1000/s | 0ms | 1ms | 3ms | 60000 | 1 |
| query-search | 1000/s | 0ms | 1ms | 3ms | 60000 | 1 |
| header-match | 1000/s | 0ms | 1ms | 4ms | 60000 | 1 |
...
Images tested:
- Control Plane: ghcr.io/nantian-gw/nantian-controlplane:ci-5c3389dee533cc5e4d14f466c94e8702e5f98f75
