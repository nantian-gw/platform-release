# Nightly Test Results — 2026-09-25

| Test | Result |
|------|--------|
| Conformance | 615 passed, 0 failed, 22 skipped |
| Performance | 780149 fixed-rate requests, success rate 1, saturation 50.015 RPS |

## Performance Scenarios

| Scenario | Rate | p50 | p95 | p99 | Requests | Success |
|----------|------|-----|-----|-----|----------|---------|
| simple | 3000/s | 11ms | 19ms | 24ms | 150149 | 1 |
| path-users | 2000/s | 5ms | 13ms | 19ms | 120000 | 1 |
| path-orders | 2000/s | 4ms | 11ms | 18ms | 120000 | 1 |
...
Images tested:
- Control Plane: ghcr.io/nantian-gw/nantian-controlplane:ci-600e5ef610ccbd71a7092eeea60cb420a2c1beae
