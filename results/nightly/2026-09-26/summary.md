# Nightly Test Results — 2026-09-26

| Test | Result |
|------|--------|
| Conformance | 615 passed, 0 failed, 22 skipped |
| Performance | 806505 fixed-rate requests, success rate 1, saturation 50.015 RPS |

## Performance Scenarios

| Scenario | Rate | p50 | p95 | p99 | Requests | Success |
|----------|------|-----|-----|-----|----------|---------|
| simple | 3000/s | 9ms | 16ms | 22ms | 176505 | 1 |
| path-users | 2000/s | 3ms | 7ms | 14ms | 120000 | 1 |
...
| response-header-filter | 1000/s | 0ms | 1ms | 4ms | 60000 | 1 |
...
Images tested:
- Control Plane: ghcr.io/nantian-gw/nantian-controlplane:ci-85521c22ca34ea0af314c5c07ffc74b0478e4cff
